...
fn get_simple_intrinsic(ccx: &CrateContext, name: &str) -> Option<ValueRef> {
    let llvm_name = match name {
        ...
        "amdgcn_read_workdim" => "llvm.amdgcn.read.workdim",
        "amdgcn_ngroups_x" => "llvm.amdgcn.ngroups.x",
        "amdgcn_ngroups_y" => "llvm.amdgcn.ngroups.y",
        "amdgcn_ngroups_z" => "llvm.amdgcn.ngroups.z",
        "amdgcn_global_size_x" => "llvm.amdgcn.global.size.x",
        "amdgcn_global_size_y" => "llvm.amdgcn.global.size.y",
        "amdgcn_global_size_z" => "llvm.amdgcn.global.size.z",
        "amdgcn_local_size_x" => "llvm.amdgcn.local.size.x",
        "amdgcn_local_size_y" => "llvm.amdgcn.local.size.y",
        "amdgcn_local_size_z" => "llvm.amdgcn.local.size.z",
        ...
        "amdgcn_global_offset_x" => "llvm.amdgcn.global.offset.x",
        "amdgcn_global_offset_y" => "llvm.amdgcn.global.offset.y",
        "amdgcn_global_offset_z" => "llvm.amdgcn.global.offset.z",
        "r600_read_workdim" => "llvm.r600.read.workdim",
        ...
        "r600_read_global_offset_x" => "llvm.r600.read.offset.x",
        "r600_read_global_offset_y" => "llvm.r600.read.offset.y",
        "r600_read_global_offset_z" => "llvm.r600.read.offset.z",
        _ => return None
    };
